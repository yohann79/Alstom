    ...
    <div class = "form-group">
        ...
        <div class = "col-md-4">
             <select name="STATUT">
                    ...
                    <option value="V" <?= (isset($creneauP[0]->STATUT)? ($creneauP[0]->STATUT== "V" ? "selected" : ''): '')?> >Valider</option>
                    <option value="O" <?= (isset($creneauP[0]->STATUT)? ($creneauP[0]->STATUT== "O" ? "selected" : ''): '')?> >Ouvert</option>
                    <option value="F" <?= (isset($creneauP[0]->STATUT)? ($creneauP[0]->STATUT== "F" ? "selected" : ''): '')?> >Fermer</option>
                    <option value="T" <?= (isset($creneauP[0]->STATUT)? ($creneauP[0]->STATUT== "T" ? "selected" : ''): '')?> >Terminer</option>
                </select>
        </div>
    </div>
    <div class = "form-group">
